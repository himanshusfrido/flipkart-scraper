...
async def scrape_fsn_pincode(
    ...
    base_result = {
        "timestamp": timestamp,
        "fsn": fsn,
        "seller_sku": row.get(INPUT_COLUMNS["sku"], ""),
        "sub_category": row.get(INPUT_COLUMNS["subcategory"], ""),
        "product_title": row.get(INPUT_COLUMNS["title"], ""),
        "seller_price": _safe_int(row.get(INPUT_COLUMNS["selling_price"], "")),
        "live_price": None,
        "mrp": _safe_int(row.get(INPUT_COLUMNS["mrp"], "")),
        "discount_pct": "",
        "price_match": "",
        "fulfillment_by": row.get(INPUT_COLUMNS["fulfillment"], ""),
        "seller_stock": _safe_int(row.get(INPUT_COLUMNS["stock"], "")),
        "pincode": pincode,
        "city": city,
        "in_stock": None,
        "delivery_date": "N/A",
